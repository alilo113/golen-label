    ...
    <div className="p-10 bg-gray-100 relative">
      ...
      >
        <div className="flex flex-nowrap space-x-6">
          {/* Card 1 */}
          <div className="flex-none w-80 bg-white shadow-lg rounded-lg p-6">
          ...
          {/* Card 2 */}
          <div className="flex-none w-80 bg-white shadow-lg rounded-lg p-6">
            <h2 className="text-3xl font-semibold text-gray-800 mb-4">Our Craft</h2>
            <p className="text-lg">
          ...
          {/* Card 3 */}
          <div className="flex-none w-80 bg-white shadow-lg rounded-lg p-6">
            <h2 className="text-3xl font-semibold text-gray-800 mb-4">Our Process</h2>
            <p className="text-lg">
          ...
          {/* Card 4 */}
          <div className="flex-none w-80 bg-white shadow-lg rounded-lg p-6">
            <h2 className="text-3xl font-semibold text-gray-800 mb-4">Our Tradition</h2>
            <p className="text-lg">
